...
export default class ETitleBar extends Component<EProps>{
    ...
    //     const {
    //         title, description, controller, style, className, bgColor, border, boxshow, padding,
    //         uri, moreText } = this.props

    //     return (
    //         <View style={Object.assign({}, style, bgColor ? { backgroundColor: bgColor } : {})}
    //             className={classNames({
    //                 'padding-10': padding,
    //                 'border': border,
    //                 'boxshow': boxshow,
    ...
    //             {title && <View className="title-bar">
    //                 <View className="title">{title}</View>
    //                 {controller && <View className="controller">{controller}</View>}
    //                 {uri && <View className="more">{moreText || '更多'}</View>}
    //             </View>}
    //             {description && <View className="description-bar">{description}</View>}
    //         </View>
    //     )
    // }
}
